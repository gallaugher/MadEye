...
#else
  {  9, -1 , 0 }, // LEFT EYE display-select and wink pins, no rotation // JMG - was 0, then 3
...
// DISPLAY HARDWARE SETTINGS (screen type & connections) -------------------
  ...
  #else
    #define DISPLAY_DC       11  // Data/command pin for ALL displays // JMG Edit
    #define DISPLAY_RESET    12  // Reset pin for ALL displays // JMG Edit
  #endif
#endif
...
// #define TRACKING            // If defined, eyelid tracks pupil - JMG removed this
...
#define IRIS_SMOOTH         // If enabled, filter input from IRIS_PIN
  ...
  #define IRIS_MIN      80 // Iris size (0-1023) in brightest light // JMG Change - was 120 
#endif
#if !defined(IRIS_MAX)
  #define IRIS_MAX      275 // Iris size (0-1023) in darkest light // JMG Change - was 720
#endif
